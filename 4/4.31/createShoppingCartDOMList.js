...
export const createShoppingCartDOMList = (productList, shoppingCartList, totalPrice) => {
    ...
    if (length !== 0){
        ...
        const shoppingCartTitle = `В корзине ${length} товар${getWordEnding(length)} на сумму ${totalPrice} руб.`;
